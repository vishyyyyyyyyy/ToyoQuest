...
<Link className="w-96 h-24 bg-red-600 rounded-[107px] ml-[536px] mt-[559px] absolute justify-start text-white text-3xl font-bold font-['Inter']" href = "./financials">Get Started</Link>
