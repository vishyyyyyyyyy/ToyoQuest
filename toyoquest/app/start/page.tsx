...
export default function Start() {
    ...
    <div className="w-44 h-[1000.08px] left-[1148px] -top-[20px] absolute origin-top-left rotate-[-28deg] bg-red-200 rounded-3xl" />
<div className="w-44 h-[469.20px] left-[857px] top-[-56.01px] absolute origin-top-left rotate-[-28deg] bg-red-600 rounded-3xl" />
<Link className="w-96 h-24 bg-red-600 rounded-[107px] ml-[536px] mt-[559px] absolute flex items-center justify-center text-white text-3xl font-bold font-['Inter'] " href = "./financials">Get Started</Link>
