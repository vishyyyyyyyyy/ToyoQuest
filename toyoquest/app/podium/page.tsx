...
export default function podium() {  
  ...
  <div className="w-[652px] h-5 left-[400px] top-[620px] absolute bg-red-600 rounded-2xl border border-black" />
  ...
  <div className="w-[637px] h-3.5 left-[330px] top-[660px] absolute inline-flex whitespace-nowrap gap-1">
    ...
    <Link href="/financials" className="text-red-600 text-base font-normal font-['Inter'] underline">Adjust your finances</Link>
    <span className="text-black text-base font-normal font-['Inter']">or</span>
    <Link href="/quiz" className="text-red-600 text-base font-normal font-['Inter'] underline">retake the quest</Link>
