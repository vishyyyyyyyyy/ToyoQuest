...
export default function podium() {  
  return (
     <>
      <Navbar />
      <div className="w-[1512px] h-[900px] relative bg-white overflow-hidden">
        <Confetti />
  <div className="left-[473px] top-[60px] absolute justify-start text-black text-4xl font-bold font-['Inter']">Your Champions of the Road!</div>
  <div className="left-[430px] top-[110px] absolute justify-start text-black text-2xl font-normal font-['Inter']">Your best Toyota fits, ranked and ready for the road.</div>
  <div className="w-[652px] h-5 left-[444px] top-[711px] absolute bg-red-600 rounded-2xl border border-black" />
  ...
  <div className="w-28 h-6 left-[409px] top-[642px] absolute bg-red-600 rounded-xl" />
  <div className="left-[411px] top-[647px] absolute justify-start text-white text-xs font-normal font-['Inter']">click to learn more</div>
  <div className="w-[637px] h-3.5 left-[452px] top-[760px] absolute justify-start"><span className="text-black text-base font-normal font-['Inter']">Not satisfied with your journey’s outcome? </span><span className="text-red-600 text-base font-normal font-['Inter'] underline">Adjust your finances</span><span className="text-black text-base font-normal font-['Inter'] underline"> </span><span className="text-black text-base font-normal font-['Inter']">or </span><span className="text-red-600 text-base font-normal font-['Inter'] underline">retake the quest</span><span className="text-black text-base font-normal font-['Inter']"> to explore new matches!</span></div>
